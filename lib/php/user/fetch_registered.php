...
if (isset($_POST["action"])) {
    if ($_POST["action"] == 'fetch') {
        ...
        if (isset($_POST["start_date"], $_POST["end_date"]) && $_POST["start_date"] != '' && $_POST["end_date"] != '') {
            // Ensure we're comparing only the date part, using the DATE() function for the comparison
            $search_query .= 'DATE(created_at) BETWEEN "' . $_POST["start_date"] . '" AND "' . $_POST["end_date"] . '" AND ';
        }
